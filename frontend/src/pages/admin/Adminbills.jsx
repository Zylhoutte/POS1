...
const AdminBills = () => {
  ...
  return (
    <AdminLayout>
      ...
      {
        popModal && 
        <Modal title="Invoice Details" width={400} pagination={false} open={popModal} onCancel={() => setPopModal(false)} footer={false}>
          <div className="card" ref={componentRef}>
            <div className="cardHeader">
                <h2 className="logo">MP POS</h2>
                <span>Number: <b>+6300000</b></span>
                <span>Address: <b>Arsaf lang</b></span>
            </div>
